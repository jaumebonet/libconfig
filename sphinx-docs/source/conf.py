...
from libconfig._version import get_versions
...
htmlhelp_basename = 'libconfigdoc'
...
latex_documents = [
    (master_doc, 'libconfig.tex', u'libconfig Documentation',
...
man_pages = [
    (master_doc, 'libconfig', u'libconfig Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'libconfig', u'libconfig Documentation',
     author, 'libconfig', 'A global configuration manager.',
     'Library management'),
]
